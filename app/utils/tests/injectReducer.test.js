...
describe('injectReducer decorator', () => {
    ...
    beforeAll(() => {
        reducerInjectors.default = jest.fn()
    ...
    it('should inject a given reducer', () => {
        ...
        expect(injectors.injectReducer)
            .toHaveBeenCalledTimes(1);
        expect(injectors.injectReducer)
            .toHaveBeenCalledWith('test', reducer);
    });

    it('should set a correct display name', () => {
        expect(ComponentWithReducer.displayName)
    ...
    it('should propagate props', () => {
        ...
        expect(renderedComponent.prop('testProp'))
            .toBe('test');
    });
});
